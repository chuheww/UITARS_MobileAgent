...
#######################################     版本说明      #########################################
## 没有memory_switch   没有reflection_switch
## perception_infos加到了uitars的action_prompt中
## 有prompt_planning
...
while True:
    ...
    prompt_action = get_action_prompt_uitars(instruction, perception_infos, width, height, keyboard, summary_history, action_history, summary, action, add_info, error_flag, completed_requirements, memory)
